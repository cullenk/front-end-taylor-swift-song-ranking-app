...
@Component({
  selector: 'app-the-life-of-a-showgirl-ranking',
  standalone: true,
  imports: [DragDropModule, CommonModule],
  templateUrl: './the-life-of-a-showgirl-ranking.component.html',
  styleUrl: './the-life-of-a-showgirl-ranking.component.scss'
})
export class TheLifeOfAShowgirlRankingComponent {
 rankings: Ranking[] = [];
  songs: Song[] = [];
  ...
  loadAlbumData() {
    this.albumService.getAlbumByTitle("The Life of a Showgirl").subscribe(
      (album: Album) => {
  ...
  loadRankings() {
    this.rankingsService.getUserRankings().subscribe(
      (rankings: Rankings) => {
        if (rankings && rankings.albumRankings && rankings.albumRankings['theLifeOfAShowgirl']) {
          this.rankings = rankings.albumRankings['theLifeOfAShowgirl'].sort((a, b) => a.rank - b.rank);
  ...
  updateRankings() {
    ...
    this.rankingsService.updateRanking('theLifeOfAShowgirl', newRankings).subscribe(
