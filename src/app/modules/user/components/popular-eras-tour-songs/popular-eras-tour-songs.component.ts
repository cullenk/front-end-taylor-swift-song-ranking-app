...
@Component({
  selector: 'app-popular-eras-tour-songs',
  standalone: true,
  imports: [BaseChartDirective, CommonModule],
  templateUrl: './popular-eras-tour-songs.component.html',
  styleUrl: './popular-eras-tour-songs.component.scss'
})
export class PopularErasTourSongsComponent {
  ...
  ngOnInit(): void {
    this.userService.getPopularErasTourSongs().subscribe((songs: Song[]) => {
