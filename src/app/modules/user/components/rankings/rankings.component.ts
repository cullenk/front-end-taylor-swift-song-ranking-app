...
export class RankingsComponent implements OnInit, OnDestroy {
  ...
  albums: Album[] = [
    ...
    { id: '1989', title: '1989', coverImage: 'https://all-taylor-swift-album-covers.s3.us-east-2.amazonaws.com/1989.jpeg', sampleAudio: 'https://all-taylor-swift-albums.s3.us-east-2.amazonaws.com/Sound+Clips/1989-sound-clip.mp3', routerLink: './1989' },
    ...
    { id: 'ttpd', title: 'The Tortured Poets Department', coverImage: 'https://all-taylor-swift-album-covers.s3.us-east-2.amazonaws.com/ttpd.jpg', sampleAudio: 'https://all-taylor-swift-albums.s3.us-east-2.amazonaws.com/Sound+Clips/ttpd-sound-clip.mp3', routerLink: './ttpd' }
  ];
